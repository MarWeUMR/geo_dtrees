...
impl Table {
    ...
    pub fn from_ndarray(
        df: ArrayBase<ndarray::OwnedRepr<f32>, Dim<[usize; 2]>>,
        ...
        let shape = df.raw_dim();
        let mut n_rows = Some(shape[0] as usize);
        let n_cols = shape[1];
